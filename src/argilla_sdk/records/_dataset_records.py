...
class DatasetRecords(Resource, Iterable[Record]):
    """
    This class is used to work with records from a dataset and is typically accessed via `Dataset.records`.
    ...
    Instead, you can access it from a public dataset object:
    ...
    def add(
        ...
        Add records to a dataset with a mapping to consume data structures in its native format:
        ...
        We can use the mapping parameter to map the keys in the native data structure to the fields and questions in
        Argilla. The dot notation is used to access suggestions and responses in the records.
    ...
    def update(
        ...
        Update records in a dataset as dictionaries. The `id` or `external_id` should be provided to \
        ...
        Update records in a dataset with a mapping to consume data structures in its native format:
    ...
    def to_dict(self, flatten: bool = True, orient: str = "names") -> Dict[str, Any]:
        ...
        Output the records as a dictionary orientated by names:
    ...
    def to_list(self, flatten: bool = True) -> List[Dict[str, Any]]:
        ...
        Properties:
            flatten (bool): Whether to flatten the dictionaries in the list and use dot notation for nested keys.
